...
const DEVICES = {
    ...
    lumiRemoteSwitch: {
        ID: 2,
        type: 'EndDevice',
        ieeeAddr: '0x00158d000424a9a6',
        networkAddress: 15854,
        manufacturerID: 4151,
        manufacturerName: 'LUMI',
        powerSource: 'Battery',
        ...
        endpoints: [
            {
                ...
                profileID: 260,
                deviceID: 24321,
                inputClusters: [0, 3, 25, 65535, 18],
                outputClusters: [0, 4, 3, 5, 25, 65535, 18],
                deviceNetworkAddress: 15854,
                deviceIeeeAddress: '0x00158d000424a9a6',
                clusters: { genBasic: [], genMultistateInput: [] },
                binds: [],
                configuredReportings: [],
                meta: {},
            },
    ...
    somgomsSwitch: {
        ID: 2,
        type: 'EndDevice',
        ieeeAddr: '0x0000000000000013',
        networkAddress: 15854,
        manufacturerID: 4151,
        manufacturerName: '_TZE200_oisqyl4o',
        powerSource: 'Battery',
        modelID: 'TS0601',
        applicationVersion: 9,
        stackVersion: 2,
        ...
        endpoints: [
            {
                ...
                outputClusters: [0, 4, 3, 5, 25, 65535, 18],
                deviceNetworkAddress: 15854,
                deviceIeeeAddress: '0x0000000000000013',
                clusters: { genBasic: [], genMultistateInput: [] },
                binds: [],
                configuredReportings: [],
                meta: {},
    ...
    tuyaSmartDimmer: {
        ID: 2,
        type: 'EndDevice',
        ieeeAddr: '0x0000000000000014',
        networkAddress: 43413,
        manufacturerID: 4098,
        ...
        endpoints: [
            {
                ...
                deviceIeeeAddress: '0x0000000000000014',
                clusters: { genBasic: [], genMultistateInput: [] },
                binds: [],
                configuredReportings: [],
                meta: {},
...
function getDevice(name) {
    ...
    if (STRUCT) {
        return model_1.Device.create(STRUCT.type, STRUCT.ieeeAddr, STRUCT.networkAddress, STRUCT.manufacturerID, STRUCT.manufacturerName, STRUCT.powerSource, STRUCT.modelID, STRUCT.interviewCompleted, STRUCT.endpoints);
    }
    throw new Error(`Unknown device with name ${name}`);
}
exports.getDevice = getDevice;
//# sourceMappingURL=device-builder.js.map